              ...
              <View style={styles.dropdownMenu}>
                ...
                >
                  ...
                  {selectedTab === 'specials' && (
                    <IconSymbol ios_icon_name="checkmark" android_material_icon_name="check" size={20} color={colors.employeeAccent} />
                  )}
                </Pressable>
                <Pressable
            ...
            >
              {specialsLoading ? (
                ...
                specials.map((special) => (
                  <View key={special.id} style={commonStyles.employeeCard}>
                ...
                {Object.entries(groupedItems).length === 0 ? (
                  ...
                  Object.entries(groupedItems).map(([groupName, groupItems]) => (
                    <View key={groupName} style={styles.categorySection}>
                      ...
                      {groupItems.map((item) => (
                        <View key={item.id} style={commonStyles.employeeCard}>
                          <View style={styles.menuItemContent}>
                            {item.image_url && (
...
const styles = StyleSheet.create({
  ...
  dropdownItemActive: {
    backgroundColor: colors.employeeAccent + '10',
  },
  dropdownItemText: {
    fontSize: 15,
    fontWeight: '500',
