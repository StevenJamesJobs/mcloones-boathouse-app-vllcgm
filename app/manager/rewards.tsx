      ...
      <View style={[commonStyles.employeeContainer, styles.container]}>
        ...
        >
          <View style={styles.placeholderContainer}>
            <IconSymbol name="star.fill" color={colors.managerAccent} size={64} />
            <Text style={styles.placeholderTitle}>Rewards Management</Text>
            <Text style={styles.placeholderText}>
              Award McLoone&apos;s Bucks to employees. Track rewards and leaderboard.
            </Text>
