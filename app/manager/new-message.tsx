              ...
              {loading ? (
                ...
                <ScrollView style={styles.recipientList} nestedScrollEnabled>
                  ...
                  {filteredGroups.map((group) => (
                    ...
                    >
                      <MaterialIcons name="group" size={24} color={colors.managerAccent} />
                      <View style={styles.groupInfo}>
                        <Text style={styles.groupTitle}>{group.job_title}</Text>
                        <Text style={styles.groupCount}>{group.count} employees</Text>
                      </View>
                      <MaterialIcons name="add-circle" size={24} color={colors.managerAccent} />
                    </Pressable>
                  ))}
                  ...
                  {filteredRecipients.map((recipient) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <MaterialIcons name="check-circle" size={24} color={colors.managerAccent} />
                        )}
                      </Pressable>
                    );
                  })}
