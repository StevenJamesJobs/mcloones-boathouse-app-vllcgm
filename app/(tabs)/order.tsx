                    ...
                    <View key={item.id} style={commonStyles.card}>
                      <View style={styles.menuItemContent}>
                        ...
                        <View style={styles.menuItemDetails}>
                          ...
                          {item.description && (
                            <Text style={styles.menuItemDescription} numberOfLines={3I can see that the `order.tsx` file is importing the deleted hooks (`useCustomerProfile` and `useOrders`). Since you decided not to implement the ordering functionality, I need to update this file to remove those dependencies. Let me create a simplified version that just displays the menu without the ordering functionality:

<write file="app/(tabs)/order.tsx">
import React, { useState } from 'react';
import { View, Text, StyleSheet, ScrollView, Pressable, Platform, ActivityIndicator, Image, Alert } from 'react-native';
import { Stack } from 'expo-router';
import { colors, commonStyles } from '@/styles/commonStyles';
